...
class SocialBlock extends BlockBase
{
    ...
    public function build()
    {
        ...
        $instagram  = Instagram::getPosts(4);
        $twitter    = Twitter::getPosts(4);
        $posts      = array_merge($instagram, $twitter);
        ...
        $slick = '<div class="slick">' . $output . '</div>';
...
class Instagram {
    public static function getPosts($num) {
        ...
        while ($num > $count) {
            ...
            $items[$count] = '<div class="social-slide social-instagram"><img src="' . $thumb .'" alt="'. $caption .'" /><p>' . $caption .'</p><div class="social-icon"><span class="fa fa-instagram"></span></div></div>';
            $count++;
        }
        return $items;
    }
...
class Twitter {
    ...
    public static function getPosts($num) {
        ...
        $items = array();
        while ($num > $count) {
//            $thumb = $obj[$count]->images->standard_resolution->url;
